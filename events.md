...
最終更新: 2026-06-21 06:28 / 8 件

## AWS公式イベント

- **AWS Summit Japan 2026**（2026-06-25～26 / 幕張メッセ（千葉県））
  - AWSサービスに関する最新情報と技術セッション、AIエージェント活用に関する講演を含む2日間の大規模カンファレンス
...
- **全日本AIハッカソン 2026 5thラウンド**（2026-07-25 / Tokyo）
  - AIを活用したプログラミングハッカソン、3時間の制限時間で開発テーマに沿った作品を制作。
